...
- **Resampling methods**: Bicubic (4×4 Catmull-Rom), bilinear, nearest-neighbor and Lanczos-3 resampling (optimized with precomputed LUTs and batched tile fetches). 
...
| `--resampling`  | `bicubic`     | Interpolation method: `lanczos`, `bicubic`, `bilinear`, `nearest` |
