...
| **Pixel types** | 8-bit RGB/RGBA · 16-bit unsigned (linear or log rescaling) · 32/64-bit float and 16/32-bit signed integer (elevation; signed 16-bit also as rescaled grayscale) |
